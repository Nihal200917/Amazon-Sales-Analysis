...
> What would be the status of the Total Profit throught the years?

 
### Specific Question
This question should be answered before we could answer the general question.

> What would be the probability that the sales profit could only go up 2010 to 2020 
...
interactive_plot <- ggplotly(plot1, tooltip = c("x", "y"))
...
interactive_plot <- ggplotly(plot2, tooltip = c("x", "y"))
